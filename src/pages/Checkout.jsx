                ...
                <div className="bg-white p-4 flex flex-col">
                    ...
                    <label className="mb-3">
                        ...
                        <input
                            ...
                            onChange={(e) => setDetails({ ...details, prenume: e.target.value })}
                            required
                        />
                    </label>
                    <label className="mb-3">
                        ...
                        <input
                            className="border-1 border-gray-500 p-1 w-full rounded"
                            value={details.judet}
                            onChange={(e) => setDetails({ ...details, judet: e.target.value })}
                            required
                        />
                    </label>
                    <label className="mb-3">
                        ...
                        <input
                            ...
                            onChange={(e) => setDetails({ ...details, localitate: e.target.value })}
                            required
                        />
                    </label>
                    <label className="mb-3">
                        ...
                        <input
                            ...
                            onChange={(e) => setDetails({ ...details, strada: e.target.value })}
                            required
                        />
                    </label>
                    <label className="mb-3">
                        ...
                        <input
                            className="border-1 border-gray-500 p-1 w-full rounded"
                            value={details.numar}
                            onChange={(e) => setDetails({ ...details, numar: e.target.value })}
                            required
                        />
                    </label>
                ...
                <div className="bg-white p-2">
                    ...
                    <label className="mb-3">
                        ...
                        <input
                            ...
                            onChange={(e) => setDetails({ ...details, voucher: e.target.value })}
                            required
                        />
