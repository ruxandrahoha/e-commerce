    ...
    <footer className="bg-neutral-900 text-white py-12 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h2 className="text-2xl font-bold mb-4 text-accent-400">📚 Librăria Modernă</h2>
          ...
          <div>
            ...
            <div className="space-y-2 text-neutral-300">
              <p>
                ...
                <a href="tel:+40123456789" className="hover:text-accent-400 transition-colors">
                  +40 123 456 789
                </a>
              </p>
              <p>
                <span className="font-medium">Email:</span>{" "}
                <a href="mailto:contact@libraria.ro" className="hover:text-accent-400 transition-colors">
                  contact@libraria.ro
                </a>
              </p>
              <p>
                <span className="font-medium">Adresă:</span> Bd. Vasile Pârvan nr.4, București
              </p>
            </div>
          </div>
